...
{
	private		static	String				pre_init_source;
	private		static	String				pre_def_source;
	private		static	String				post_def_source;
	private		static	final
		Vector <String>  					inner_class_names;
	private		static	final
		HashMap <String, String>			inner_class_inits;
	private		static	final
		HashMap <String, String>			inner_class_defs;
	static
	{
		inner_class_names	= new Vector <String> ( );
		inner_class_inits	= new HashMap <String, String> ( );
		inner_class_defs	= new HashMap <String, String> ( );
		prefix				= "Extension";
	}
